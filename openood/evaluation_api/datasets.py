...
DATA_INFO = {
    ...
    "imagenet200": {
        ...
        "id": {
            "train": {
                ...
                "imglist_path": "benchmark_imglist/imagenet200/train_imagenet200.txt",
            },
            "val": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist/imagenet200/val_imagenet200.txt",
            },
            "test": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist/imagenet200/test_imagenet200.txt",
            },
        },
        "csid": {
            ...
            "imagenet_v2": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist/imagenet200/test_imagenet200_v2.txt",
            },
            "imagenet_c": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist/imagenet200/test_imagenet200_c.txt",
            },
            "imagenet_r": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist/imagenet200/test_imagenet200_r.txt",
            },
        },
        "ood": {
            "val": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist/imagenet200/val_openimage_o.txt",
            },
            "near": {
                "datasets": ["ssb_hard", "ninco"],
                "ssb_hard": {
                    "data_dir": "images_largescale/",
                    "imglist_path": "benchmark_imglist/imagenet200/test_ssb_hard.txt",
                },
                "ninco": {
                    "data_dir": "images_largescale/",
                    "imglist_path": "benchmark_imglist/imagenet200/test_ninco.txt",
                },
            },
            "far": {
                ...
                "inaturalist": {
                    "data_dir": "images_largescale/",
                    "imglist_path": "benchmark_imglist/imagenet200/test_inaturalist.txt",
                },
                "textures": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist/imagenet200/test_textures.txt",
                },
                "openimage_o": {
                    "data_dir": "images_largescale/",
                    "imglist_path": "benchmark_imglist/imagenet200/test_openimage_o.txt",
                },
            },
        },
    },
    "imagenet": {
        ...
        "csid": {
            ...
            "imagenet_c": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist/imagenet/test_imagenet_c.txt",
            },
            "imagenet_r": {
                "data_dir": "images_largescale/",
        ...
        "ood": {
            ...
            "near": {
                ...
                "ssb_hard": {
                    "data_dir": "images_largescale/",
                    "imglist_path": "benchmark_imglist/imagenet/test_ssb_hard.txt",
                },
                "ninco": {
                    "data_dir": "images_largescale/",
...
benchmarks_dict = {
    "cifar10": ["cifar10", "cifar100", "tin", "mnist", "svhn", "texture", "places365"],
    "cifar100": ["cifar100", "cifar10", "tin", "mnist", "svhn", "texture", "places365"],
    "imagenet200": [
        "imagenet_1k",
        "ssb_hard",
        "ninco",
    ...
    for dataset_name in data_info["csid"]["datasets"]:
        dataset = ImglistDataset(
            ...
            data_dir=os.path.join(
                data_root, data_info["csid"][dataset_name]["data_dir"]
            ),
            num_classes=data_info["num_classes"],
            preprocessor=(
                preprocessor
                if dataset_name != "imagenet_c"
                else imagenet_c_preprocessor
            ),
            data_aux_preprocessor=test_standard_preprocessor,
        )
        dataloader = DataLoader(dataset, **loader_kwargs)
