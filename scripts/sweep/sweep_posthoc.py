...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--benchmarks", nargs="+", default=["mnist", "cifar10", "cifar100", "imagenet"]
    )
    ...
    parser.add_argument("--launcher", default="local", choices=["local", "slurm"])
    ...
    args_list = make_args_list(
        args.benchmarks, args.methods, args.metrics, benchmark_dict
    )
