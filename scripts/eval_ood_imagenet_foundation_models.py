...
parser.add_argument(
    "--arch",
    default="ViT-B/16",
    choices=clip.available_models() + ["ViT-S/14", "ViT-B/14", "ViT-L/14"],
)
...
root = os.path.join(
    ROOT_DIR, "results", f"imagenet_{args.model_type}_{args.arch.replace('/', '-')}"
)
...
if args.model_type == "clip":
    net = CLIPZeroshot(
        classnames=imagenet_classes, templates=imagenet_templates, backbone=args.arch
    )
