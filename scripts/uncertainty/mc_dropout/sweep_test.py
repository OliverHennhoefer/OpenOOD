...
config = [
    [
        "osr_cifar6/cifar6_seed1.yml",
        "osr_cifar6/cifar6_seed1_ood.yml",
        "resnet18_32x32",
        "osr_cifar6_seed1_dropout_net_base_e100_lr0.1_default",
    ],
    [
        "osr_cifar50/cifar50_seed1.yml",
        "osr_cifar50/cifar50_seed1_ood.yml",
        "resnet18_32x32",
        "osr_cifar50_seed1_dropout_net_base_e100_lr0.1_default",
    ],
    [
        "osr_tin20/tin20_seed1.yml",
        "osr_tin20/tin20_seed1_ood.yml",
        "resnet18_64x64",
        "osr_tin20_seed1_dropout_net_base_e100_lr0.1_default",
    ],
    [
        "osr_mnist4/mnist4_seed1.yml",
        "osr_mnist4/mnist4_seed1_ood.yml",
        "lenet",
        "osr_mnist4_seed1_dropout_net_base_e100_lr0.1_default",
    ],
]
